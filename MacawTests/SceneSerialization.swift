...
private func typeForString(_ string: String) -> PathSegmentType {
    switch(string) {
    case "M": return .M
    case "m": return .m
    case "L": return .L
...
private func lineCapForString(_ string: String) -> LineCap {
    switch(string) {
...
private func lineJoinForString(_ string: String) -> LineJoin {
    switch(string) {
...
private func baselineForString(_ string: String) -> Baseline {
    switch(string) {
    case "top": return .top
